...
namespace ConsoleUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Cart total: {cart.GenerateTotal(SubTotalAlert, CalculateLeveledDiscount, AlertUser):C2}");
            Console.WriteLine();


            // creating delegates in-line
            ...
            Console.WriteLine($"Total after discount for cart 2: {total:C2}");
